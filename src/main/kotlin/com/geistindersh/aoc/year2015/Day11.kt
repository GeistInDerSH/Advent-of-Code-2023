...
class Day11(dataFile: DataFile) {
	...
	private fun String.hasMonotonicAlphabeticSeq() = this
		.windowed(3) { seq ->
	...
	private fun String.containsUniqueLetterPairs() = this
		.windowed(2)
	...
	private fun isValidPassword(str: String) =
		str.hasMonotonicAlphabeticSeq() && !str.containsBadChars() && str.containsUniqueLetterPairs()
	...
	private fun String.nextValid() = generateSequence(this.next()) { it.next() }
