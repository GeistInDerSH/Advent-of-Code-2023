...
class Day13(dataFile: DataFile) {
	private val data = fileToStream(2015, 13, dataFile)
		.map { line ->
	...
	private fun optimalSeatingHappiness(people: Set<String>, happinessMap: Map<Pair<String, String>, Int>) = people
		.permutations()
		.maxOf { group ->
	...
	fun part2(): Int {
		val us = "Us"
		val data = data.toMutableMap().also {
