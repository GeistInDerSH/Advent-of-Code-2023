 ...
 */
fun Int.setBit(position: Int, value: Int): Int = this and (1 shl position).inv() or (value shl position)
 ...
 * @return A copy of [this] with the updated bit
 */
fun Long.setBit(position: Int, value: Long): Long = this and (1L shl position).inv() or (value shl position)
