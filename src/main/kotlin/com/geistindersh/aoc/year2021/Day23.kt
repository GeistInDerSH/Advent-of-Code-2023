...
class Day23(dataFile: DataFile) {
    ...
    private data class Diagram(val hallway: List<Amphipods>, val rooms: Map<Amphipods, Room>) {
        ...
        private fun moveableHallwayAmphipods() =
            hallway
                .withIndex()
        ...
        private fun hallwayIsClearBetween(
            start: Int,
            end: Int,
        ): Boolean {
    ...
    private fun organize(start: Diagram): Int {
        val queue =
            PriorityQueue<Pair<Diagram, Int>>(compareBy { it.second })
